...
int main (void)
{
 // char 'a', 'v', 'c', 'g' caracteres
 // int -5, 0, 7 inteiros
 // float -6.3f, 0.0, 2.4f decimais
 // double -6.3, 0.0, 2.4 decimais mais precisos
 // void nada
  ...
  printf("\n");
  printf("o tamanho do short int na memoria e %lu byte(s)\n", sizeof(short int));  
  printf("o tamanho do long int na memoria e %lu byte(s)\n", sizeof(long int));
  printf("o tamanho do long double na memoria e %lu byte(s)\n", sizeof(long double));
  ...
  printf("a faixa de valores do unsigned short vai de %i ate %i\n", 0, USHRT_MAX);
